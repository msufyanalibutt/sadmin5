                ...
                <div className="actions-right">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      if (obj.id) {
                        this.props.history.push(`${REACT_APP_ADMIN_PATH}/featureList-editFeature/${obj.id}`);
                      }
                    }}
                    color="twitter"
                    className="edit"
          ...
          <Button
            ...
            onClick={(e) => {
              ...
              exportData(dataToexport ? dataToexport : this.reactTable.current.getResolvedState().sortedData.slice(0, 10), keys)
                ...
                <Button
                onClick={() => {this.props.history.push(`${REACT_APP_ADMIN_PATH}/featureList-addFeature`);}}
                color="success"
