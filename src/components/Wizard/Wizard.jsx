...
class Wizard extends React.Component {
  ...
  render() {
    const { classes, title, subtitle, color, steps, match, data,className } = this.props;
    return (
      <div className={classes.wizardContainer} ref="wizard" className={className}>
        <Card className={classes.card}>
          ...
          <div className={classes.footer} style={{marginTop: "60px"}}>
